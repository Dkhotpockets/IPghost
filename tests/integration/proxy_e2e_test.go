...
func TestProxyE2E_HTTPMasking(t *testing.T) {
	...
	// Start proxy server
	srv := proxy.NewProxyServer("127.0.0.1:0", net.ParseIP("127.0.0.1"), []string{"http"}, 100, 10*time.Second, logger)
...
// testLogger implements common.Logger for testing purposes
type testLogger struct{ t *testing.T }

func (l *testLogger) Info(msg string, args ...interface{})  { l.t.Logf("INFO: "+msg, args...) }
func (l *testLogger) Error(msg string, args ...interface{}) { l.t.Errorf("ERROR: "+msg, args...) }
